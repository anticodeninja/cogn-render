 ...
 * @constructor
 */
function FBO(context, textures, depth_texture, stencil)
{
...
FBO.prototype.setTextures = function(color_textures, depth_texture, skip_disable)
{
    ...
    if(depth_texture &&
       depth_texture.constructor === core.Texture &&
...
FBO.prototype.update = function(skip_disable) {
	...
	for(var i = 0; i < color_textures.length; i++)
	    ...
	    if(t.constructor !== core.Texture) {
	        throw("FBO can only bind instances of Texture");
            }
    ...
    if(depth_texture && depth_texture.constructor === core.Texture) {
...
FBO.prototype.bind = function(keep_old) {
    ...
    this._old_viewport.set(this.context.viewport_data);
...
FBO.prototype.unbind = function()
{
    ...
    gl.bindFramebuffer(gl.FRAMEBUFFER, this._old_fbo_handler);
    this._old_fbo_handler = null;
    this.context.setViewport(this._old_viewport);
